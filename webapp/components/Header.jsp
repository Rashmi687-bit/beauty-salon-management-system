<header class="bg-white shadow-sm fixed top-0 left-0 right-0 z-10">
    <div class="flex items-center justify-between px-6 py-3">
        ...
        <nav class="hidden md:flex items-center space-x-8">
            ...
            <a href="Admin_Appoinments.html" class="text-gray-600 hover:text-indigo-600">Appointments</a>
            <a href="#" class="text-gray-600 hover:text-indigo-600">Clients</a>
            <a href="#" class="text-gray-600 hover:text-indigo-600">Services</a>
            <a href="#" class="text-gray-600 hover:text-indigo-600">Staff</a>
